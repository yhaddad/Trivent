...
carefulDownload.sh DHCAL_${NRUN}_I0_0.slcio $INPUTDIR
carefulDownload.sh DHCAL_${NRUN}_I1_0.slcio $INPUTDIR
carefulDownload.sh DHCAL_${NRUN}_I2_0.slcio $INPUTDIR
carefulDownload.sh DHCAL_${NRUN}_I3_0.slcio $INPUTDIR
...
<marlin>
  ...
  <global>
    <parameter name="LCIOInputFiles">
      DHCAL_${NRUN}_I0_0.slcio
      DHCAL_${NRUN}_I1_0.slcio
      DHCAL_${NRUN}_I2_0.slcio
      DHCAL_${NRUN}_I3_0.slcio
    </parameter>
  ...
  <processor name="MyTriventProc" type="TriventProc">
    ...
    <parameter name="LCIOOutputFile" value="./TDHCAL_${NRUN}_${En}GeV.slcio"/>
  </processor>
...
./carefulUpload.sh TDHCAL_${NRUN}_${En}GeV.slcio $OUTPUTDIR
