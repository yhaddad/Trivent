...
INPUTDIR=/grid/calice/SDHCAL/TB/CERN/${TBperiod}/STREAMOUT
...
os.system('lfc-ls /grid/calice/SDHCAL/TB/CERN/SPS_AugSep2012/STREAMOUT')
os.system('lfc-ls /grid/calice/SDHCAL/TB/CERN/SPS_AugSep2012/STREAMOUT > file.txt')
    ...
    for ss in index:
        ...
        for run in runs:
            if run in split_list:
                print ss
                cmd = './carefulDownload.sh'+' '+ss+' '+'/grid/calice/SDHCAL/TB/CERN/SPS_AugSep2012/STREAMOUT'
                os.system(cmd)
